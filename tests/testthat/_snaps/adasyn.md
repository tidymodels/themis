# bad distance arg for step_adasyn()

    Code
      bake(prep(step_adasyn(recipe(class ~ x + y, data = circle_example), class,
...
# indicator_column bad args
    ...
    Code
      step_adasyn(recipe(class ~ x + y, data = circle_example), class,
      indicator_column = 1)
    Condition
      Error in `step_adasyn()`:
...
---
    ...
    Code
      prep(step_adasyn(recipe(class ~ x + y, data = circle_example), class,
      indicator_column = ""))
    Condition
      Error in `step_adasyn()`:
