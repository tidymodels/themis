...
test_that("bsmote() interfaces correctly", {
  ...
  expect_error(bsmote(circle_example_num, var = c("class", "x")))

  expect_error(bsmote(circle_example_num, var = "x"))
  ...
  expect_error(bsmote(circle_example_num, var = "class", k = 0))

  expect_error(bsmote(circle_example_num, var = "class", k = -1))

  expect_error(bsmote(circle_example_num, var = "class", k = c(5, 10)))
})
