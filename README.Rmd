...
[![Travis build status](https://travis-ci.org/EmilHvitfeldt/themis.svg?branch=master)](https://travis-ci.org/EmilHvitfeldt/themis)
[![Codecov test coverage](https://codecov.io/gh/EmilHvitfeldt/themis/branch/master/graph/badge.svg)](https://codecov.io/gh/EmilHvitfeldt/themis?branch=master)
<!-- badges: end -->

**themis** contain extra steps for the
[`recipes`](https://CRAN.R-project.org/package=recipes) package for
dealingwith unbalanced data. The name **themis** is that of the [ancient Greek god](https://thishollowearth.wordpress.com/2012/07/02/god-of-the-week-themis/) who is typically  depicted with a balance.
...
The following methods all share the tuning parameter `under_ratio`, which is the ratio of the minority-to-majority frequencies.

| name | function | Multi-class |
|---|---|---|
| Random majority under-sampling with replacement | `step_downsample()` | :heavy_check_mark: |
| NearMiss-1 | `step_nearmiss()` | :heavy_check_mark: |
