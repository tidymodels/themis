...
This outlines how to propose a change to themis. For more detailed info
...
Please note that the themis project is released with a [Contributor Code
of Conduct](https://themis.tidymodels.org/dev/CODE_OF_CONDUCT.md). By
