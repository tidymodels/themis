...
![Bar chart with 5 columns. class on the x-axis and count on the y-axis.
Class a has height 10, b has 20, c has 30, d has 40, and e has
50.](reference/figures/README-unnamed-chunk-2-1.png)
...
|----|----|----|
| Random minority over-sampling with replacement | [`step_upsample()`](https://themis.tidymodels.org/reference/step_upsample.md) | ✔️ |
| Synthetic Minority Over-sampling Technique | [`step_smote()`](https://themis.tidymodels.org/reference/step_smote.md) | ✔️ |
| SMOTE for datasets with continuous and nominal features | [`step_smotenc()`](https://themis.tidymodels.org/reference/step_smotenc.md) | ✔️ |
| SMOTE for nominal features only | [`step_smoten()`](https://themis.tidymodels.org/reference/step_smoten.md) | ✔️ |
| Borderline SMOTE-1 | `step_bsmote(all_neighbors = FALSE)` | ✔️ |
| Borderline SMOTE-2 | `step_bsmote(all_neighbors = TRUE)` | ✔️ |
| Support-vector SMOTE | [`step_svmsmote()`](https://themis.tidymodels.org/reference/step_svmsmote.md) | ✔️ |
| KMeans-SMOTE | [`step_kmeans_smote()`](https://themis.tidymodels.org/reference/step_kmeans_smote.md) | ✔️ |
| Adaptive synthetic sampling approach for imbalanced learning | [`step_adasyn()`](https://themis.tidymodels.org/reference/step_adasyn.md) | ✔️ |
| Generation of synthetic data by Randomly Over Sampling Examples | [`step_rose()`](https://themis.tidymodels.org/reference/step_rose.md) |  |
...
![Bar chart with 5 columns. class on the x-axis and count on the y-axis.
class a, b, c, d, and e all have a height of
...
![Bar chart with 5 columns. class on the x-axis and count on the y-axis.
Class a has height 25, b has 25, c has 30, d has 40, and e has
50.](reference/figures/README-unnamed-chunk-4-1.png)
...
|----|----|----|----|
| Random majority under-sampling with replacement | [`step_downsample()`](https://themis.tidymodels.org/reference/step_downsample.md) | ✔️ | ✔️ |
| NearMiss-1, NearMiss-2, and NearMiss-3 | `step_nearmiss(version = )` | ✔️ | ✔️ |
| Instance hardness threshold | [`step_instance_hardness()`](https://themis.tidymodels.org/reference/step_instance_hardness.md) | ✔️ | ✔️ |
| Cluster centroids | [`step_cluster_centroids()`](https://themis.tidymodels.org/reference/step_cluster_centroids.md) | ✔️ | ✔️ |
| Condensed nearest neighbors | [`step_cnn()`](https://themis.tidymodels.org/reference/step_cnn.md) | ✔️ |  |
| Edited nearest neighbors | [`step_enn()`](https://themis.tidymodels.org/reference/step_enn.md) | ✔️ |  |
| Neighborhood cleaning rule | [`step_ncl()`](https://themis.tidymodels.org/reference/step_ncl.md) | ✔️ |  |
| One-sided selection | [`step_oss()`](https://themis.tidymodels.org/reference/step_oss.md) | ✔️ |  |
| Extraction of majority-minority Tomek links | [`step_tomek()`](https://themis.tidymodels.org/reference/step_tomek.md) |  |  |
...
![Bar chart with 5 columns. class on the x-axis and count on the y-axis.
Class a has height 10, b, c, d, and e have ha height of
20.](reference/figures/README-unnamed-chunk-6-1.png)
