...
`step_svmsmote()` creates a *specification* of a recipe step that
generate new examples of the minority class near the decision boundary
using the support vectors of a fitted support vector machine.
...
[`svmsmote()`](https://themis.tidymodels.org/reference/svmsmote.md) for
